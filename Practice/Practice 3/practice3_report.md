...
В качестве метода ветвления был выбран Trunk, так как проект небольшой и разрабатывался одним человеком.  
Данный подход позволяет легко контролировать внедрение нового функционала и всегда иметь готовую к деплою версию приложения, на 
ветке "master".
